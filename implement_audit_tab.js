...
// 2. Update activeTab type and defaultTab matching
content = content.replace(
...
// 3. Inject auditData useMemo before `return (`
const auditDataBlock = `
  const auditData = useMemo(() => {
    ...
    extOrders.forEach(o => processOrder(o, 'social'));
...
content = content.replace(/  return \(/, auditDataBlock);

// 4. Replace the old stats tab JSX with the new audit tab
