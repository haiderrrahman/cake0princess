...
export default function PhotoEditorHub() {
  return (
    <div className="min-h-screen bg-[#0d0d1a] p-4 md:p-6 pt-24 pb-28 md:pt-6 md:pb-6" dir="rtl">
      ...
      {/* Tools Grid */}
      <div className="grid grid-cols-5 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-2 sm:gap-3 md:gap-4">
        {TOOLS.map((tool, i) => (
          <Link
            key={i}
            href={tool.href}
