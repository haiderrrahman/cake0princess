...
export default function QuickEntrySupply({ onSuccess }: { onSuccess: () => void }) {
  ...
  useEffect(() => {
    getDocs(collection(db, "supplies_categories")).then(snap => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        {imagePreview ? (
          ...
          <div className="text-center">
            ...
            <span className="text-xs text-gray-500 font-bold">صورة المادة</span>
          </div>
        )}
      ...
      <div>
        <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-2">اسم المادة</label>
        <div className="relative">
          <Tag className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
          <input 
            type="text" value={name} onChange={e => setName(e.target.value)}
            className="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl px-4 py-3 pr-10 text-sm focus:ring-2 focus:ring-orange-500 outline-none"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl px-4 py-3 pr-10 text-sm focus:ring-2 focus:ring-orange-500 outline-none text-left"
        ...
        <div>
          ...
          <select 
            ...
            className="w-full bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-orange-500 outline-none appearance-none"
          >
      ...
      <button
        onClick={submitSupply} disabled={submitting}
        className="w-full bg-gradient-to-l from-orange-500 to-orange-700 text-white py-4 rounded-xl font-black text-sm flex items-center justify-center gap-2 mt-4 shadow-lg active:scale-95 transition"
      >
